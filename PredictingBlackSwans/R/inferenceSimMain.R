...
#'
#' Computes all the results for the simulation study with our preferred implementation
#' using the "desparsified Hessian" to estimate the standard error.
...
#' @examples inferenceSimMain()
inferenceSimMain <- function(path        = getwd(),
                             n           = 100,
                             p           = 150,
                             rho         = 0.5,
                             nSim        = 100,
  ...
  while (i <= nSim) {
    ...
    seArray[posInfeas, i, 2] <- stdErrors
  ...
  stargazer::stargazer(mCoverage,
                       type="html",
                       out=paste0("Coverage_Results_n_", n, "_p_", p, "_rho_", rho, ".html"),
  ...
  stargazer::stargazer(tResults,
                       type="html",
                       out=paste0("Hypothesis_Testing_n_", n, "_p_", p, "_rho_", rho, ".html"),
  ...
  stargazer::stargazer(tResultsLow,
                       type="html",
                       out=paste0("Hypothesis_Testing_LowDim_n_", n, "_p_", p, "_rho_", rho, ".html"),
  ...
  ggsave(paste0("InferSim_AllMethods_NonzeroCoefs_n", n, "_p_", p, "_rho_", rho, ".png"), plot=pt, units="cm",
         height=10, width=15)
  ...
  ggsave(paste0("InferSim_WithoutInfeasible_n_", n, "_p_", p, "_rho_", rho, ".png"), plot=pt,
  ...
  ggsave(paste0("InferSim_Zero_Coefficients_n_", n, "_p_", p, "_rho_", rho, ".png"), plot=pt,
         units="cm", height=10, width=15)
  ...
  saveRDS(inferenceList, file=paste0("Inference_Results_", listName, ".rds"))
}
